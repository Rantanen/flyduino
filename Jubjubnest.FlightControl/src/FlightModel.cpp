...
_FlightModel::_FlightModel()
	: orientation(1,0,0,0),
		...
		yawOffsetPID( PID_YAW_OFFSET_KP, PID_YAW_OFFSET_KI, PID_YAW_OFFSET_KD ),
		pitchOffsetPID( PID_TILT_OFFSET_KP, PID_TILT_OFFSET_KI, PID_TILT_OFFSET_KD ),
		rollOffsetPID( PID_TILT_OFFSET_KP, PID_TILT_OFFSET_KI, PID_TILT_OFFSET_KD ),
#endif
		yawRateError( 0 ), pitchRateError( 0 ), rollRateError( 0 ),
		yawRatePID( PID_YAW_RATE_KP, PID_YAW_RATE_KI, PID_YAW_RATE_KD ),
		pitchRatePID( PID_TILT_RATE_KP, PID_TILT_RATE_KI, PID_TILT_RATE_KD ),
		rollRatePID( PID_TILT_RATE_KP, PID_TILT_RATE_KI, PID_TILT_RATE_KD )
{
